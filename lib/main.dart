...
import 'managerScreen/manager.dart';
import 'managerScreen/Reviews.dart';
import 'managerScreen/Ratings.dart';
import 'managerScreen/EditCredentials.dart';
import 'managerScreen/AboutUs.dart';
import 'managerScreen/ContactUs.dart';
import 'managerScreen/ViewProfile.dart';
...
class ManagerView extends StatefulWidget {
  @override
  _MyManagerViewState createState() => _MyManagerViewState();
}

class _MyManagerViewState extends State<ManagerView> {
      ...
      drawer: new Drawer(
        ...
        new UserAccountsDrawerHeader(
          ...
          currentAccountPicture: new GestureDetector(
            ...
            backgroundImage: new AssetImage('assets/eventmanager.jpg'),
          )),
        ),
        new ListTile(
...
//_navigateToScreen1(BuildContext context){
